...
function write_panel_svg_content($map_info)
{
  ...
  {
    $x_transform = $my_map_size["width"] - 800 - 2; // -10 sind die r�nder
    $y_transform = $my_map_size["height"] - 600; // -55 ist die statusleiste
  }
  else
  {
    //$x_transform = $my_map_size["width"] + 150; // -10 sind die r�nder
    //$y_transform = $my_map_size["height"] - 600 + 17 - 75; // -55 ist die statusleiste
    $x_transform = $my_map_size["width"] - 800 - 10; // -10 sind die r�nder
    $y_transform = $my_map_size["height"] - 600 + 17 - 75; // -55 ist die statusleiste
  }
...
//echo("</g>\n"); // Ende Transform Translate
  ...
  // mop: vertical align noch nicht unterst�tzt :@
